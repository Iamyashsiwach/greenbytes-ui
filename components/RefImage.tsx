...
export const RefImage: React.FC<RefImageProps> = ({ mode, filename }) => {
  ...
  return (
    <Card className="mt-4 border-2 border-orange-200 bg-orange-50/50">
        ...
        <div className="space-y-3">
          <div className="relative group">
            <img 
              ...
              className="w-full max-h-48 object-contain rounded-lg border border-orange-200 bg-white shadow-sm group-hover:shadow-md transition-shadow"
              onError={(e) => {
