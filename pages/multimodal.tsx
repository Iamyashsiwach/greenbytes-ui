            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-600">Multimodal Analysis</p>
                </div>
              ...
              {messages.length === 0 && (
                <Card className="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-2xl font-bold text-green-800">GreenBytes AI</h2>
                    <p className="text-green-700">Multimodal sugarcane health analysis</p>
                        ...
                        {(['disease', 'pest'] as const).map((m) => (
                          ...
                          >
                            <input
                              ...
                              className="sr-only"
                            />
                            <span className="text-lg">{m === 'disease' ? '🦠' : '🐛'}</span>
                            <div>
                            ...
                            {mode === m && <Check className="w-4 h-4 ml-auto text-primary" />}
                          </Label>
                        ))}
                      </div>
                    </div>
                        ...
                        <Card key={question.key} className="p-3">
                          ...
                          >
                            <div className="flex items-center space-x-1">
                              ...
                              <Label htmlFor={`${question.key}-unknown`} className="text-xs">Unknown</Label>
                            </div>
                            <div className="flex items-center space-x-1">
                              <RadioGroupItem value="0" id={`${question.key}-no`} />
                              <Label htmlFor={`${question.key}-no`} className="text-xs">No</Label>
                            </div>
                            <div className="flex items-center space-x-1">
                              <RadioGroupItem value="1" id={`${question.key}-yes`} />
                              <Label htmlFor={`${question.key}-yes`} className="text-xs">Yes</Label>
                            </div>
                          </RadioGroup>
                        </Card>
                      ))}
      ...
      <div className="flex justify-end">
        <Card className="max-w-2xl bg-primary text-primary-foreground">
          <CardContent className="p-4">
            ...
            {imagePreview && (
              <img src={imagePreview} alt="Uploaded" className="w-full max-h-32 object-cover rounded mb-3" />
            )}
            ...
            <Card className={`border-2 ${result.fusion.detected ? 'border-destructive/20 bg-destructive/5' : 'border-green-200 bg-green-50'}`}>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className={`text-lg font-bold ${result.fusion.detected ? 'text-destructive' : 'text-green-600'}`}>
